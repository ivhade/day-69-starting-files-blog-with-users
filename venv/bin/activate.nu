...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Users/maureenoyakhilome/Downloads/day-69-starting-files-blog-with-users/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Users/maureenoyakhilome/Downloads/day-69-starting-files-blog-with-users/venv/bin/deactivate.nu'
